...
def main():
    ...
    button_mp=Button
    f=Frame(root,height=70,width=1200,bg='Blue')
    #f.propagate(0)
    f.pack()
    ...
    #f.propagate(0)
    v.pack()
    q=Label(v,text='TAP HERE TO PLAY MULTIPLAYER',fg='black',height=3)
    q.pack()
    ...
    #f.propagate(0)
    m.pack()
    i=Label(m,text='TAP HERE TO PLAY SINGLEPLAYER',fg='black',height=3)
    i.pack()
    
    button2=Button(g,bg='lightblue', height=2, width=20,text='Multiplayer',fg='black',bd=3,command=multi_player)
    #button2.place(bordermode=INSIDE)
    button2.grid(row=3,column=1)
    
     
    button3=Button(k,bg='lightblue', height=2, width=20,text='single player',fg='black',bd=3,command=single_player)
    #button2.place(bordermode=INSIDE)
